...
class Ship
{
	...
	final static int row_idx = 0;
	final static int col_idx = 1;
...
class Board
{
	final static private int ALREADY_HIT = -1;
	final static private int EMPTY_CELL = 0;
	final static int row_idx = 0;
	final static int col_idx = 1;
	final static int NO_FLOATING_SHIPS=0;
